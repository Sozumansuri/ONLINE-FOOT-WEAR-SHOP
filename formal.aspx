<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="formal.aspx.vb" Inherits="formal" title="Untitled Page" %>
                     	 ...
                     	 margin-top :5px;
                            ...
                            <div class="a">
                                <asp:Image ID="img1" runat="server" Height="300px" 
                                    ImageUrl='<%#eval("ino","handler3.ashx?ino={0}") %>' Width="300px" />
                            </div>
                             <style type="text/css">
