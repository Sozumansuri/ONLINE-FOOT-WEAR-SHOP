...
Partial Class admin10
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        FileUpload1.SaveAs(Server.MapPath("~/temp10/") + FileUpload1.FileName)

        Dim s As String = Server.MapPath("~/temp10/") + FileUpload1.FileName
        Dim fs As New FileStream(s, FileMode.Open, FileAccess.Read)
        Dim br As New BinaryReader(fs)
        Dim bytes As Byte() = br.ReadBytes(fs.Length)

        CMD = New SqlCommand("insert into prod10 values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "',@img1)", CN)
