<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="admin15.aspx.vb" Inherits="admin15" title="Untitled Page" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder6" Runat="Server">
    <table class="style1" style="background-color: #CCFFFF">
        <tr>
            ...
            <td colspan="2">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <span class="style19">&nbsp;SCHOOL&nbsp; SHOES</span>&nbsp;</td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
