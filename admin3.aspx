<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="admin3.aspx.vb" Inherits="admin3" title="Untitled Page" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder6" Runat="Server">
    <table class="style1" style="background-color: #CCFFFF">
        <tr>
            ...
            <td colspan="2">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <span class="style19">&nbsp;FORMAL SHOES</span></td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
