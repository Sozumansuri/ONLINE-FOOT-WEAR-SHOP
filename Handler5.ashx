<%@ WebHandler Language="VB" Class="Handler5" %>
Imports System.Data.SqlClient

Imports System
Imports System.Web

Public Class Handler5 : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        cn.Open()
        cmd = New SqlCommand("select image from prod5 where ino=" + context.Request.QueryString("ino"), cn)
