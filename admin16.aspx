<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="admin16.aspx.vb" Inherits="admin16" title="Untitled Page" %>
...
<asp:Content ID="Content7" ContentPlaceHolderID="ContentPlaceHolder6" Runat="Server">
    <table class="style1" style="background-color: #CCFFFF">
        <tr>
            <td>
                &nbsp;</td>
            <td colspan="2">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <span class="style19">&nbsp;SANDELS</span>&nbsp;</td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button2" runat="server" style="font-weight: 700; height: 26px;" 
                    Text="SHOW ADMIN FORM" />
            </td>
            <td>
                &nbsp;</td>
        </tr>
