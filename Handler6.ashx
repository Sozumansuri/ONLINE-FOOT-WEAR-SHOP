<%@ WebHandler Language="VB" Class="Handler6" %>
Imports System.Data.SqlClient

Imports System
Imports System.Web

Public Class Handler6 : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        cn.Open()
        cmd = New SqlCommand("select image from prod6 where ino=" + context.Request.QueryString("ino"), cn)
