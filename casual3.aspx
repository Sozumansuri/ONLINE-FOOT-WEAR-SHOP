<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="casual3.aspx.vb" Inherits="casual3" title="Untitled Page" %>
                     	 ...
                     	 margin-top :5px;
                            ...
                            <div class="a">
                                <asp:Image ID="img1" runat="server" Height="300px" 
                                    ImageUrl='<%#eval("ino","handler12.ashx?ino={0}") %>' Width="300px" />
                            </div>
                            <style type="text/css">
